...
export default function InviteContacts() {
  ...
  // FIXED: Properly implement the renderContactItem function
      ...
      <View style={styles.contactInfo}>
        ...
        <View style={styles.contactDetails}>
          <Text 
            ...
            testID={`contact-name-${item.id}`}
          >
            {item.name}
          </Text>
          <Text 
            style={styles.contactPhone} 
            testID={`contact-phone-${item.id}`}
          >
            {item.phoneNumber}
          </Text>
        </View>
